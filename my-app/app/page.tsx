...
function getFrameImage(activePage: string, inputText?: string) {
  switch (activePage) {
    case "1":
      return <FrameImage src="https://i.scdn.co/image/ab67616d0000b27328933b808bfb4cbbd0385400" />
    case "2":
      return <FrameImage aspectRatio="1.91:1"><div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>Request some songs: {inputText}</div></FrameImage>
    case "3":
      return <FrameImage src="https://i.scdn.co/image/ab67616d0000b27328933b808bfb4cbbd0385400" />
    default:
      return null
  ...
  return (
    <div className="p-4">
      ...
      >
        ...
        <FrameButton action="link" target={`https://www.youtube.com/watch?app=desktop&v=N-_mHedypEU`}>
          Listen!!!
        </FrameButton>
      </FrameContainer>
    </div>
